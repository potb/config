...
in {
  systemd.services.${service-name} = {
    ...
    in ''
      ...
      # Retry logic: try up to 3 times with 5 second delay
      RETRY_COUNT=0
      MAX_RETRIES=3
      SUCCESS=false

      # Step 1: Fetch the listing page and extract the latest POTW link
      ...
      # Step 2: Fetch the specific POTW page and find the largest JPEG
      RETRY_COUNT=0
      SUCCESS=false
      ...
      # Extract all JPEG URLs from cdn.esahubble.org, sort, and get the largest
